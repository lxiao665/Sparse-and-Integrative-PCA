cv_inner<-function(Y,Sigma0_est=NULL,PrevPi_Eig=NULL,PrevPi_d=NULL,pseq,w,w_e,rho,rho1=NULL,rho2=NULL,indice,ndim,t,K,rhostep,eps){
  fold=length(indice)
  ...
  for(i in 1:length(indice)){
    ...
    Strain = Strain - Sigma0_est
    Stest = Stest - Sigma0_est
