getRho<-function(Y,Sigma0_est=NULL,PrevPi_Eig=NULL,PrevPi_d=NULL,pseq,w=NULL,w_e=NULL,rho,alphaseq,rho0seq,fold,ndim,op,t,K,rhostep,eps){
  ...
  indice=Kindice(N,fold)
    ...
    Vsplit=apply(rho1.rho2.candi,1,FUN=function(u){
      cv_inner(Y=Y,Sigma0_est=Sigma0_est,PrevPi_Eig=PrevPi_Eig,PrevPi_d=PrevPi_d,pseq=pseq,w=w,w_e=w_e,rho=rho,rho1=u[1],rho2=u[2],indice=indice,ndim=ndim,t=t,K=K,rhostep=rhostep,eps=eps)
    }) 
    
    # Vsplit=list(rho1.rho2.candi,Vsplit)
