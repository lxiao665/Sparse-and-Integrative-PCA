CV<-function(Y,PrevPi_Eig=NULL,PrevPi_d=NULL,pseq,w=NULL,w_e=NULL,rho,alphaseq,rho0seq,fold,ndim,eps,maxiter){
  ...
  Vsplit=getRho(Y=Y,PrevPi_Eig=PrevPi_Eig,PrevPi_d=PrevPi_d,pseq=pseq,w=w,w_e=w_e,rho=rho,alphaseq=alphaseq,rho0seq=rho0seq,fold=fold,ndim=ndim,eps=eps,maxiter=maxiter)
